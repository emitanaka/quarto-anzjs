...
<http://onlinelibrary.wiley.com/journal/10.1111/%28ISSN%291467-842X>
...
referred to in the (real) book _A Maze of Death_ by @Dick1971.  The aforesaid title exemplifies a
...
[@Dick1968] upon which the movie _Blade Runner_ (starring
...
Melvin Mingdinkler and Hoo Hee, cited via `@NurkEtAl1984`,
would yield "@NurkEtAl1984".
...
and B. Carson, cited via `@TrumpEtAl2021` 
would yield "@TrumpEtAl2021". 
...
In the example shown in @fig-ltdb, `n1` and
...
`\label{fig-ltdb}` or `\label{tbl-ltdb}`) and labels
...
all.  I don't _do_ Windows\texttrademark!
